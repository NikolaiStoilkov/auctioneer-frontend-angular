...
import { StripeHttpAdapter } from './infrastructure/http/stripe-http.adapter';
import { WalletHttpAdapter } from './infrastructure/http/wallet-http.adapter';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: StripePort, useClass: StripeHttpAdapter },
    { provide: WalletPort, useClass: WalletHttpAdapter },
  ],
};
